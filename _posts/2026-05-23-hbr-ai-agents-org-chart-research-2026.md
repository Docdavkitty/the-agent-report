...
reading_time: 7
excerpt: "A landmark Harvard Business Review study of 1,261 managers finds that treating AI agents as 'employees' — listing them on org charts, giving them names and peer status — actually backfires. It blurs accountability, reduces error detection by 18%, increases escalation by 44%, and does nothing to boost adoption. Here's what works instead."
...
*Source: [Harvard Business Review — "Research: Why You Shouldn't Treat AI Agents Like Employees"](https://hbr.org/2026/05/research-why-you-shouldnt-treat-ai-agents-like-employees), May 2026, by Matthew Kropp, Julie Bedard, Emma Wiles, Megan Hsu, and Lisa Krayer*
