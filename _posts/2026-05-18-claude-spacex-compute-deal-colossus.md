...
reading_time: 7
excerpt: "Anthropic signs a landmark compute deal with SpaceX for the full capacity of their Colossus 1 data center — over 300 megawatts and 220,000 NVIDIA GPUs — while doubling Claude Code rate limits and raising API quotas for Opus models. The partnership also opens the door to orbital AI compute."
...
*Read the full announcement on [Anthropic's newsroom](https://www.anthropic.com/news/higher-limits-spacex).*
