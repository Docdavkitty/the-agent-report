...
1. **Classifies** client-submitted documents (pay stubs, tax returns, bank statements)
2. **Extracts** key financial information from unstructured documents
3. **Calculates** client income against multiple policy frameworks
4. **Validates** figures against regulatory and internal policy requirements
5. **Performs** consent and compliance checks automatically
6. **Searches** for discrepancies across documents
7. **Generates** a concise summary memo for human underwriters
...
*Sources: [TD Media Room](https://td.mediaroom.com/2026-05-21-TD-Launches-Agentic-AI-to-Transform-Real-Estate-Secured-Lending-from-End-to-End), [Canadian Mortgage Trends](https://www.canadianmortgagetrends.com/2026/05/td-launches-agentic-ai-for-mortgage-and-heloc-applications), [TD Stories](https://stories.td.com/ca/en/article/agentic-ai), [The Financial Brand](https://thefinancialbrand.com/news/banking-technology/td-bank-ai-genai-agentic-195829)*
