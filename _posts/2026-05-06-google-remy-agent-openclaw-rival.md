...
According to an internal document seen by [Business Insider](https://www.businessinsider.com/google-ai-agent-openclaw-remy-gemini-assistant-2026-5), Google has been quietly developing a new AI "personal agent" codenamed **Remy** that runs inside a staff-only version of the Gemini app. The agent is described as a "24/7 personal agent for work, school, and daily life, powered by Gemini" — and it's designed to do far more than answer questions.
...
> — Internal Google document, per Business Insider
...
This "proactive agent" paradigm is the direction every major AI lab is racing toward. OpenAI has [GPT-5.5 Instant](https://techcrunch.com/2026/05/06/openai-releases-gpt-5-5-instant-a-new-default-model-for-chatgpt/) with agentic capabilities, Anthropic's Claude has [computer use](https://docs.anthropic.com/en/docs/agents-and-tools/computer-use), and OpenClaw's meteoric rise — now at 368,000+ GitHub stars — has proven that there's massive demand for autonomous digital workers.
...
- **OpenClaw** — the open-source phenomenon now at 368,000+ stars, with autonomous capabilities across messaging, voice, file management, and [recently Google Meet integration](https://the-agent-report.com/2026/05/05/openclaw-v2026-5-4-google-meet-file-transfer/)
- **Anthropic's Claude** — expanding into [enterprise financial services agents](https://the-agent-report.com/2026/05/05/anthropic-fis-ai-agent-financial-crime-banking/) and computer use capabilities
- **OpenAI** — with GPT-5.5 Instant and [CopilotKit raising $27M](https://techcrunch.com/2026/05/06/copilotkit-raises-27m-to-help-devs-deploy-app-native-ai-agents/) for app-native agent deployment
- **Meta** — launching [Muse Spark from its new Superintelligence Labs](https://the-agent-report.com/2026/05/05/meta-ai-muse-spark-superintelligence-labs/)
- **AWS** — enabling [agents to drive Workspaces virtual desktops](https://www.theregister.com/2026/05/06/aws_workspaces_agent_access/)
