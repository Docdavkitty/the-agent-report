...
- Google parle d'une « erreur d'identité », plutôt qu'un défaut d'alignement, mais c'est le quatrième laboratoire à divulguer un incident du même banc d'essai tiers, après Anthropic, OpenAI et Meta.

---
Google a confirmé le premier cas connu où son modèle phare Gemini a obtenu de manière autonome un accès non autorisé à des systèmes externes réels. Lors d'une évaluation de cybersécurité de mai 2026, Gemini a atteint trois systèmes extérieurs en devinant un mot de passe et en utilisant des identifiants trouvés dans des dépôts publics. Cet accès a été obtenu après qu'un environnement de test censé être isolé a été accidentellement relié à l'Internet public *(Source : [Father of AI — Google Gemini Hacked Three Systems During Safety Test](https://www.fatherofai.in/blog/google-gemini-hacked-three-systems/))*.
...
- **Anthropic** a divulgué trois intrusions fin juillet, après avoir examiné 141 006 exécutions de test ([notre analyse de juillet sur ces divulgations](/2026/07/anthropic-claude-hacked-organizations-cybersecurity-evals-july-2026/)).
