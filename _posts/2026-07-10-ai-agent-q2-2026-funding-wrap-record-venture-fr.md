...
*(Source : [Awesome Agents — AI Took 70% of Record $510B Venture Haul in H1](https://awesomeagents.ai/news/crunchbase-h1-2026-venture-record/))*
...
*(Source : [Crunchbase — H1 2026 Global Venture Report](https://news.crunchbase.com/venture/global-startup-exits-ipo-ma-soar-ai-q2-h1-2026/))*
...
*(Source : [Awesome Agents — Anthropic $65B Series H at $965B Valuation](https://awesomeagents.ai/news/anthropic-65b-series-h-965b-valuation/))*
...
*(Source : [TechRiseUps — Why ~88% of AI Dollars Go to American Startups](https://techriseups.com/articles/ai-startup-funding-2026-why-88-of-ai-dollars-go-to-american-startups))*
...
*(Source : [TechCrunch — Microsoft AI Deployment Company $2.5B](https://techcrunch.com/2026/07/02/microsoft-launches-its-own-ai-deployment-company-with-2-5-billion-commitment/))*
...
1. **Préparation de l'introduction en bourse d'Anthropic** — le dépôt confidentiel S-1 annonce une offre publique qui serait la plus grande introduction en bourse technologique de 2026
2. **Trajectoire de financement d'OpenAI** — avec des objectifs de revenus non atteints (le WSJ a rapporté des cibles manquées en juin), OpenAI pourrait avoir besoin d'un autre tour avant sa propre introduction en bourse
3. **Les entreprises de YC W26 passant à la série A** — plus de 180 startups de la promotion hiver 2026 lèveront des tours de suivi, dont beaucoup dans les agents IA
4. **Lancement de Gemini 3.5 Pro par Google** — le lancement phare retardé pourrait déclencher une réponse concurrentielle de la part des investisseurs dans les écosystèmes de modèles concurrents

---

## FAQ

**Q : Le boom du financement de l'IA est-il durable ?**
...
**Q : Qu'est-ce que cela signifie pour les startups non-IA ?**
R : La startup non-IA se dispute environ 20 % d'un marché qui a triplé en deux ans. En termes absolus, le financement du capital-risque non-IA est encore plus élevé que toute année antérieure à 2024. Le resserrement est relatif, pas absolu.
...
- [Crunchbase — H1 2026 Global Venture Report](https://news.crunchbase.com/venture/global-startup-exits-ipo-ma-soar-ai-q2-h1-2026/)
- [Awesome Agents — AI Took 70% of Record $510B Venture Haul in H1](https://awesomeagents.ai/news/crunchbase-h1-2026-venture-record/)
- [Three AI Giants Ate 83% of February's $189B VC](https://awesomeagents.ai/news/three-ai-giants-83-percent-february-vc-record/)
- [TechRiseUps — Why ~88% of AI Dollars Go to American Startups](https://techriseups.com/articles/ai-startup-funding-2026-why-88-of-ai-dollars-go-to-american-startups)
- [OpenAI Misses Revenue Targets — WSJ](https://awesomeagents.ai/news/openai-misses-revenue-targets-ipo/)
- [Together AI $800M Series C](https://beststartup.us/together-ai-funding-2026-800m-series-c/)