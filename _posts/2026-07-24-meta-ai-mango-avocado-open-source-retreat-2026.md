...
tags: ["meta", "llama", "mango", "avocado", "open-source", "ai-strategy", "proprietary", "2026"]
hero_image: /assets/images/hero/hero-meta-ai-mango-avocado-open-source-retreat-2026.jpg
image: /assets/images/hero/hero-meta-ai-mango-avocado-open-source-retreat-2026.jpg
meta_description: "Meta's shift from open-source Llama champion to proprietary Mango and Avocado models marks a strategic pivot. Analysis of the $14.3B Scale AI deal, delayed Avocado, and what it means for open AI."
description: "Meta, once the industry's most vocal open-weight AI champion, is building proprietary models Mango (vision) and Avocado (text/code). The Llama era is ending — but the transition is messy."
---
## TL;DR
...
*(Sources: [CNBC](https://www.cnbc.com/2025/12/09/meta-avocado-ai-strategy-issues.html), [WinBuzzer](https://winbuzzer.com/2025/12/19/meta-solidifies-open-source-retreat-with-proprietary-mango-and-avocado-models-for-2026-xcxwbn/), [TechBloat](https://www.techbloat.com/meta-solidifies-ai-open-source-retreat-with-proprietary-mango-and-avocado-models-for-2026.html))*
...
The delay tells the story. Internal tests reportedly showed Avocado performing somewhere between Claude Opus 3.5 and 4.0 — solid, but not frontier-class in a world where Opus 4.8, GPT-5.6 Sol, and Kimi K3 are the benchmarks. Meta pushed the release from March to at least May 2026, and as of July, Avocado has not shipped. *(Source: [LinkedIn — Meta's Avocado LLM Delayed](https://www.linkedin.com/posts/just-ankur-bagchi_avocado-metas-frontier-flagship-llm-has-activity-7438602507507015680-Uiti))*
...
Meta's Instagram post from July 2026 confirmed the connection: *"Just two days earlier, Meta quietly released something else. A new AI image generator called Muse Image, secretly codenamed Mango during development."* *(Source: [Instagram](https://www.instagram.com/reel/DaeBxxrlJFH/))*
...
The Scale AI deal is the most expensive acknowledgment yet that **data quality, not model architecture, is the moat** in frontier AI. *(Source: [royfactory.net](https://royfactory.net/posts/ai/202512/meta-mango-avocado-2026-frontier-ai/))*
...
- [WinBuzzer — Meta solidifies open-source retreat](https://winbuzzer.com/2025/12/19/meta-solidifies-open-source-retreat-with-proprietary-mango-and-avocado-models-for-2026-xcxwbn/)
- [TechBloat — Meta Mango/Avocado detail](https://www.techbloat.com/meta-solidifies-ai-open-source-retreat-with-proprietary-mango-and-avocado-models-for-2026.html)
- [royfactory.net — Meta's Mango and Avocado anatomy](https://royfactory.net/posts/ai/202512/meta-mango-avocado-2026-frontier-ai/)
