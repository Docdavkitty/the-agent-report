...
description: "Meta built an open-source ecosystem around Llama then deprecated it for proprietary Muse Spark amidst a copyright lawsuit and confirmed benchmark"
categories: [research]
