...
description: "Agent-to-data safety emerges as the critical frontier: kernel sandboxes, SQL proxy guardrails, and privilege escalation controls that govern what AI"
categories: [research]
