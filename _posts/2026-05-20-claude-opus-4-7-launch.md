...
description: "Anthropic releases Claude Opus 4.7: state-of-the-art coding, 3x higher-res vision, better instruction following, file-based memory, and an effort"
categories: [research]
